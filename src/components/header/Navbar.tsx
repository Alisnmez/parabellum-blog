          ...
          <div className="flex bg-[#2C224B] p-4 md:order-2 md:flex md:flex-wrap md:items-center md:justify-center md:gap-4 md:w-full">
            ...
            <div className="relative hidden md:block">
              ...
              <input
                type="text"
                id="search-navbar"
                className="block w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 dark:bg-slate-600 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white focus:outline-none focus:ring-2 focus:ring-gray-800 select-none"
                placeholder="Search..."
              />
            </div>
            <button
